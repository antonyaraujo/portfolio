          ...
          <div className="hidden md:flex items-center space-x-6">
            <nav className="flex items-center space-x-6 text-sm font-mono text-text/90">
              ...
              <motion.a
                ...
                className="transition-colors duration-300"
              >
                <span className="text-primary">02.</span> {t('navbar.projects')}
              </motion.a>
              <motion.a
                whileHover={{ color: '#00ff95' }}
                href="#skills"
                className="transition-colors duration-300"
              >
                <span className="text-primary">03.</span> {t('navbar.skills')}
              </motion.a>
              <motion.a
                whileHover={{ color: '#00ff95' }}
                href="#contact"
                className="transition-colors duration-300"
              >
                <span className="text-primary">04.</span> {t('navbar.contact')}
              </motion.a>
            </nav>
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="flex mt-10 space-x-6 text-primary">
              <motion.a
                href="https://www.linkedin.com/in/antony-araujo/"
                whileHover={{ scale: 1.1, color: '#00ff95' }}
              >
                <LinkedInIcon />
              </motion.a>
              <motion.a
                href="https://github.com/Antony-Araujo"
                whileHover={{ scale: 1.1, color: '#00ff95' }}
              >
                <GitHubIcon />
              </motion.a>
              <motion.a
                href="https://bsky.app/profile/antonyaraujo.is-a.dev"
                whileHover={{ scale: 1.1, color: '#00ff95' }}
              >
                <BlueskyIcon />
              </motion.a>
